...
Fit an AR(2) model on the `gtemp_both` dataset filtered to years prior to 1951. Forecast the mean temperature deviation in 1955 using direct forecasting, and via recursive forecasting, showing that they are the same.
